...
<section id="showcase" style="margin-top: 38px;">
    <div style="display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-bottom: 16px; flex-wrap: wrap;">
        ...
        <a href="built_with.php" style="font-family: 'Oswald', sans-serif; font-weight: 600; font-size: 13px; letter-spacing: 0.06em; text-transform: uppercase;">More &amp; Submit Yours &rarr;</a>
    </div>
